        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-[30%] mt-[10vh] m-auto border-2 border-black justify-center align-middle py-9">
            ...
            <div className="grid grid-cols-2 w-[70%] mx-auto ">
                <div>
                    ...
                    <input className="border-2 mx-auto py-1 w-[90%] text-md hover:border-black duration-200" type="text" value={firstName} onChange={e => setFirstName(e.target.value || '')} id="name" />
                </div>

                <div>
                    <label className="mb-[-1vh]" htmlFor="name">Last Name</label>
                    <input className="border-2 mx-auto w-[100%] py-1 text-md hover:border-black duration-200" type="text" value={lastName} onChange={e => setLastName(e.target.value || '')} id="lastname" />
                </div>
            </div>

            <label className="ml-[15%] mb-[-1vh]" htmlFor="email">Email</label>
            <input className="border-2 w-[70%] mx-auto py-1 text-md hover:border-black duration-200" type="email" value={email} onChange={e => setEmail(e.target.value || '')}  id="email" />

            <label className="ml-[15%] mb-[-1vh]" htmlFor="password">Password</label>
            <input className="border-2 w-[70%] mx-auto py-1 text-md hover:border-black duration-200" id="password" value={password} onChange={e => setPassword(e.target.value || '')}  type="password" />

            <label className="ml-[15%] mb-[-1vh]" htmlFor="password">Confirm Password</label>
            <input className="border-2 w-[70%] mx-auto py-1 text-md hover:border-black duration-200" id="password" value={passwordConfirm} onChange={e => setPasswordConfirm(e.target.value || '')}  type="password" />
