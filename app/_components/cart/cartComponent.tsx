                        ...
                        {Object.keys(products).map(id => 
                            <div key={id} className="p-2 my-1 flex border-2 border-white hover:border-gray-500 duration-300 w-[100%] max-h-[70%]">
                                ...
                                <div className="max-h-[7rem] max-w-[7rem]">
                                    <Image src={`${process.env.NEXT_PRODUCTION == "false" ? "http" : "https"}://${process.env.NEXT_DB_IP}:8090/api/files/${products[id].prod.collectionId}/${id}/${products[id].prod.img}`} alt="Img" width={600} height={600} />
                                </div>
